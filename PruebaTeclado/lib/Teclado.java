package x4_bibliotecas;

import java.util.Scanner;

// Clase Teclado1 que incluye operaciones de entrada de datos primitivos desde teclado, 
// con salida de mensajes informativos o de error en consola.
// Utiliza la clase Scanner del paquete java.util de Java.
public class Teclado {
	
	// Escribe en consola un mensaje de solicitud de un booleano.
	// Lee un booleano por teclado.
	...
	// Escribe en consola un mensaje de solicitud de un número natural.
	// Lee un número natural (entero positivo) por teclado.
	...
	// Escribe en consola un mensaje de solicitud de un número entero.
	...
	// Escribe en consola un mensaje de solicitud de un número entero largo.
	// Lee un número entero largo por teclado.
	...
	// Escribe en consola un mensaje de solicitud de un número real.
	...
	// Escribe en consola un mensaje de solicitud de un carácter.
	...
	// Escribe en consola un mensaje de solicitud de una cadena de caracteres.
